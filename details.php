	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="<?php echo $final['picture']?>">
									<div class="wrap-pic-w pos-relative" style="height:550px">
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<button onclick="location.href='cart_handler.php?cart_id=<?php echo $final['id'] ?>&cart_name=<?php echo $final['name'] ?>&cart_price=<?php echo $final['price'] ?>'" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04" name="add-to-cart">
										Add to cart
									</button>
								</div>
							</div>	
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			<span class="stext-107 cl6 p-lr-25">
				SKU: <?php echo $final['SKU_name'] ?>-00<?php echo $final['id'] ?>
			</span>
		</div>
	</section>
