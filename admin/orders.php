        ...
        -Dev El 
         ...
         <table>
          ...
          while ($final=$results->fetch_assoc()) {
            ...
            echo "<tr><td>".$final['id']."</td><td>".'<a href="ordershow.php?pro_id='.$final['id'].'">'.$final['customer_id']."</a></td><td>".$final['total_amount']."</td><td>".'<a href="orderdelete.php?delete_id='.$final['id'].'" style="color:red">'."Delete"."</a></td></tr>"; 
